...
public class StudentController {
    ...
    @Operation(
            summary = "Get all by Name AND email",
    ...
    @Operation(
            summary = "Get all by name OR email",
    ...
    @Operation(
            summary = "Get all by department name",
            description = "find all students by department name")
    ...
    @Operation(
            summary = "Get all by subject name",
            description = "find all students by subject name")
    ...
    @Operation(
            summary = "Get all by name prefix",
